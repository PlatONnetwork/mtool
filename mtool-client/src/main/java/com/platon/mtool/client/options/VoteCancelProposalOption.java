...
/** Created by liyf. */
@Parameters(
    commandNames = {AllCommands.VOTE_CANCEL_PROPOSAL},
    commandDescriptionKey = AllCommands.VOTE_CANCEL_PROPOSAL)
public class VoteCancelProposalOption extends CommonOption {

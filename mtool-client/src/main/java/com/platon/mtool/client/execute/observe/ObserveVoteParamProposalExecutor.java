 ...
 * <p>Created by liyf.
 */
public class ObserveVoteParamProposalExecutor extends MtoolExecutor<VoteParamProposalOption> {

  private static final Logger logger =
      LoggerFactory.getLogger(ObserveVoteParamProposalExecutor.class);
  private BlockChainService blockChainService = BlockChainService.singleton();

  public ObserveVoteParamProposalExecutor(
      JCommander commander, VoteParamProposalOption commonOption) {
  ...
  public void execute(VoteParamProposalOption option) throws Exception {
    ...
    entity.setType(FuncTypeEnum.VOTE_PARAM_PROPOSAL);

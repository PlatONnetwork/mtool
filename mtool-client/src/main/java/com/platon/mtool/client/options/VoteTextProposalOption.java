...
/** Created by liyf. */
@Parameters(
    commandNames = {AllCommands.VOTE_TEXT_PROPOSAL},
    commandDescriptionKey = AllCommands.VOTE_TEXT_PROPOSAL)
public class VoteTextProposalOption extends CommonOption {

 ...
 * <p>Created by liyf.
 */
public class ObserveSubmitCancelproposalExecutor extends MtoolExecutor<SubmitCancelProposalOption> {

  private static final Logger logger =
      LoggerFactory.getLogger(ObserveSubmitCancelproposalExecutor.class);
  private BlockChainService blockChainService = BlockChainService.singleton();

  public ObserveSubmitCancelproposalExecutor(
  ...
  public void execute(SubmitCancelProposalOption option) throws Exception {
    ...
    entity.setType(FuncTypeEnum.SUBMIT_CANCEL_PROPOSAL);

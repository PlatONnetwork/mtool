 ...
 * <p>Created by liyf.
 */
public class ObserveVoteCancelProposalExecutor extends MtoolExecutor<VoteCancelProposalOption> {

  private static final Logger logger =
      LoggerFactory.getLogger(ObserveVoteCancelProposalExecutor.class);
  private BlockChainService blockChainService = BlockChainService.singleton();

  public ObserveVoteCancelProposalExecutor(
      JCommander commander, VoteCancelProposalOption commonOption) {
  ...
  public void execute(VoteCancelProposalOption option) throws Exception {
    ...
    entity.setType(FuncTypeEnum.VOTE_CANCEL_PROPOSAL);

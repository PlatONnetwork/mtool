...
import com.platon.mtool.client.converter.VersionConverter;
...
/** Created by liyf. */
@Parameters(
    commandNames = {AllCommands.SUBMIT_VERSION_PROPOSAL},
    commandDescriptionKey = AllCommands.SUBMIT_VERSION_PROPOSAL)
public class SubmitVersionProposalOption extends CommonOption {

  @Parameter(
      names = {AllParams.NEWVERSION},
      descriptionKey = AllParams.NEWVERSION,
      required = true,
      arity = 1,
